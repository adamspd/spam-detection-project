# spam_detection/test_and_tuning/test.py
...
from spam_detection.logger_config import init_logging
from spam_detection.prediction import SpamDetector
from spam_detection.training import ModelTrainer
